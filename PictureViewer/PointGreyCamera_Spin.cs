...
namespace MT3
{
	...
	ManagedCameraList camList ; //a
        IManagedCamera managedCamera;//a
        ...
        void OnImageGrabbed(ManagedImage pgr_image)
        {
            ...
            lock (this)
            {
                unsafe
                {
                    CopyMemory(imgdata.img.Data, (IntPtr)pgr_image.data, (int)imgdata.img.Total());
                }
            }
            #region 他のコピー方法
        ...
        static int PrintDeviceInfo(INodeMap nodeMap)
        {
            ...
            Console.WriteLine("X86(4) or X64(8) : {0}", IntPtr.Size);
            return result;
        }
